...
execute in the_end if entity @e[type=minecraft:player,tag=foreverworld_player,tag=!foreverworld_player_dragon_view,tag=foreverworld_player_dragon_ritual,nbt={Dimension:1}] run tag @e[type=minecraft:player,tag=foreverworld_player,tag=!foreverworld_player_dragon_view,nbt={Dimension:1}] add foreverworld_player_dragon_ritual

# Ensure the player has at least one end crystal
execute as @e[type=minecraft:player,tag=foreverworld_player,tag=!foreverworld_player_dragon_view,tag=!foreverworld_player_dragon_ritual,nbt={Dimension:1}] run execute unless entity @s[nbt={Inventory:[{id:"minecraft:end_crystal"}]}] unless entity @s[nbt={SelectedItem:{id:"minecraft:end_crystal"}}] run give @s minecraft:end_crystal
