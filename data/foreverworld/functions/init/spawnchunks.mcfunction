...
execute unless entity @e[tag=foreverworld_marker] run tp @a 0 -63 -5000000
execute unless entity @e[tag=foreverworld_marker] run summon minecraft:armor_stand 0 -63 -5000000 {Marker:1b, Invisible:1b, NoGravity:1b, Tags:["foreverworld_marker"], CustomName:"[{\"text\":\"foreverworld marker\"}]"}
