...
execute at @e[tag=foreverworld_marker] if entity @e[tag=foreverworld_playerstand_found] run tp @e[tag=foreverworld_playerstand_found] ~ ~ ~
...
execute at @e[tag=foreverworld_marker] run spawnpoint @s ~ ~ ~
