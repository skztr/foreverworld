...
execute as @e[type=minecraft:player,tag=foreverworld_player,tag=!foreverworld_player_dragon_view,nbt={Dimension:"minecraft:the_end"}] if entity @e[type=minecraft:ender_dragon] run tag @s add foreverworld_player_dragon_view

# If the portal is closed, the dragon must exist, somewhere (unless the ritual is in progress).
execute if entity @e[type=minecraft:player,tag=foreverworld_player,tag=!foreverworld_player_dragon_view,tag=!foreverworld_player_dragon_ritual,nbt={Dimension:"minecraft:the_end"}] run function foreverworld:the_end/detect/portal
execute as @e[type=minecraft:player,tag=foreverworld_player,tag=!foreverworld_player_dragon_view,tag=!foreverworld_player_dragon_ritual,nbt={Dimension:"minecraft:the_end"}] if entity @e[tag=foreverworld_exit_portal,tag=!foreverworld_exit_portal_open] run tag @s add foreverworld_player_dragon_view
...
execute if entity @e[tag=foreverworld_exit_portal] as @e[type=minecraft:player,gamemode=survival,tag=foreverworld_player,nbt={Dimension:"minecraft:the_end"},tag=!foreverworld_player_dragon_view] run function foreverworld:the_end/reset/dragon
